...
export default function StreamingTime() {
    ...
    const StreamingTimeMexicoCity = 540//600; //10 am CDMX time: antes del cambio de horario de verano: 600 
    //despues del cambio de horario de verano: 540. Cada 60 es una hr
