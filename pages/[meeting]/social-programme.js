...
export default function SocialProgramme(props) {
    ...
    return (
        <Background title={props.meetingTitle} meetingId={props.meeting} shortDescription={props.shortDescription}>
            ...
            <br />
            <p>
                <b>Important: All tickets should be acquired at Registration Desk no later than Monday January 8. Number of places available limited. First come first serve basis. Just cash in mxn (Mexican pesos) accepted.</b>
            </p>
            ...
            <p><a href="https://drive.google.com/file/d/1cX9fqsJw2pAYF0ZnWnR5AsONEo5G6rQ3/view?usp=sharing" target='_blank'>See here the menu.</a></p>
            <ul>
            ...
            <h3>January 12, Party (19:30 - 22:00)</h3>
